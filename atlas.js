...
client.on("guildMemberAdd", async member => {
  ...
  moment.locale("tr");
  kanal.send("<@" +member+ "> ses gir kayıt bekle <#993836908142669855> oku anladıysan tepkiye bas")
  });
...
client.on("guildMemberAdd", async member => {
  ...
  member.guild.channels.cache.get(`${kanal}`).send(new Discord.MessageEmbed().setColor("RANDOM").setDescription(`${member} sunucuya giriş yaptı ve <@&${rol}> başarılı bir şekilde verildi!`).setFooter(`developed by spatz`).setTimestamp())
